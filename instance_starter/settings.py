"""
Django settings for instance_starter project.
...
ROOT_URLCONF = 'instance_starter.urls'
...
# WSGI_APPLICATION = 'instance_starter.wsgi.application'
# Websocket config
ASGI_APPLICATION = 'instance_starter.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'ec2_manager'),
